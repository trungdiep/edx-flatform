...
from django.db.models.fields import BooleanField, DateTimeField, DecimalField, FloatField, IntegerField, TextField, DurationField
...
class CourseOverview(TimeStampedModel):
    ...
    relative = DurationField(null=True)
